//     WebHelp 5.10.006
var isHeaderBannerLoading = false;
...
{ //Sets Banner Image - Fujitsu san logo , blank space added in the end and removed from the beginning of anchor tag.
       if(sImage)
       {
              var nBtn=gaButtons.length;
              gaButtons[nBtn]="<td NOWRAP align=\"center\" valign=\"middle\"><img alt=\"About WebHelp\"src=\""+sImage+"\" border=0 align=\"absmiddle\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>";
              gaTypes[nBtn]="banner";
       }
}
...
function addButton(sType,nStyle,sTitle,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sI1,sI2,sI3,sI4,sI5,sI6)
{
       ...
       else if(sType=="rolesel")
       {
           var svTitle="Select a content category";
              sButton="<select title=\""+svTitle+"\" style=\"background-color:"+gsBgColorWhite+";height:25px;width:132px; margin:0 5px;\" id=\"selectRole\" name=\"selectRole\" class=\"black\" size=\"1\" onchange=\"showHelpSystem(this.id)\">";         
              sButton+="</select>";
       ...
       if(sButton.length!=0)
       {
              ...
              {      if(bHref) {
                     if (nBtn == 1) {
                           gaButtons[nBtn]="<td style='width:35px;' NOWRAP valign=\"middle\" align=\"center\" class="+btnClass+" onclick=\"onBtnClick(event);\" onmousedown=\"onBtnMouseDown(event, "+nBtn+");\" onmouseup=\"onBtnMouseUp(event, "+nBtn+");\" onmouseover=\"onBtnMouseOver(event, "+nBtn+");\" onmouseout=\"onBtnMouseOut(event, "+nBtn+");\">"+sButton+"</td>";                        
                     }
                     else {
                     ...
                     if (nBtn == 1) {
                           gaButtons[nBtn]="<td style='width:35px;'  NOWRAP valign=\"middle\" align=\"center\" class="+btnClass+" onclick=\"onBtnClick(event);return false;\" onmousedown=\"onBtnMouseDown(event, "+nBtn+");\" onmouseup=\"onBtnMouseUp(event, "+nBtn+");\" onmouseover=\"onBtnMouseOver(event, "+nBtn+");\" onmouseout=\"onBtnMouseOut(event, "+nBtn+");\">"+sButton+"</td>";
                     }
                     else {
...
function writeToolBar()
{
       ...
       if(gaButtons.length>0)
       {
              ...
              if(gbNav6)
                     sHTML="<table class=\"clsToolbarBackground borderb\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" height=\""+strHeight+"\" width=\""+strWidth+"\">";
              else {
                     ...
                     if (isHeaderBannerLoading) {
                           sHTML="<form name=\"searchForm\" method=\"POST\" action=\"javascript:searchB()\"><table id='tblBanner' style='margin-left: 0px;border-bottom: 3.5px solid #d72626;' class=\"clsToolbarBackground\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" height=\"98%\" width=\""+strWidth+"\">";
                     }
                     else {
                           sHTML="<form name=\"searchForm\" method=\"POST\" action=\"javascript:searchB()\"><table class=\"clsToolbarBackground\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" height=\""+strHeight+"\" width=\""+strWidth+"\">";
                     }
