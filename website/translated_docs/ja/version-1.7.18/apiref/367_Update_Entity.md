---
id: version-1.7.18-367_Update_Entity
title: Entity更新
...
### リクエストサンプル
```JSON
{"animalId": "100-2","name": "episode2","startedAt": "2016-02-21","episodeType": "care2",
"endedAt": "","outcome": "治療済"}
```
...
-X PUT -i -H 'Authorization: Bearer AA~PBDc...(省略)...FrTjA' -H 'Accept: application/json' -d \
