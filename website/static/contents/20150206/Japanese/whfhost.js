//	WebHelp 5.10.003
var gsNoTopics="トピックが見つかりません。";
var gsLoadXmlFailed="エラー : xml ファイルの読み込みに失敗しました。";
var gsInitDatabaseFailed="エラー : データベースの初期化に失敗しました。";
var gsNotAllDatabaseInited="警告 : 一部のデータベースが読み込まれていません。一部のトピックが見つからない可能性があります。";
var gsInvalidExpression_1="入力した内容は有効な式ではありません。";
var gsInvalidExpression_2="クリック";
var gsInvalidExpression_3="ヘルプ";
var gsInvalidExpression_4="クエリ式の使用方法について学ぶには（完了予定）";
var gsSearching="検索中...";
var gsTitle="タイトル";
var gsRank="ランク";
var gsCancel="キャンセル";
var gsCanceled="キャンセルされました";

var gsTotalNumberOfSearchResults = "検索結果の総数 : %1";
