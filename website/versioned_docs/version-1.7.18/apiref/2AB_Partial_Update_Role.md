---
id: version-1.7.18-2AB_Partial_Update_Role
title: Role partial update
sidebar_label: Role partial update
original_id: 2AB_Partial_Update_Role
---

## Overview

Partial update of Role information
...
|:--|:--|:--|:--|:--|
|Name|Role Name|Number of digits: 1 - 128<br>Character type: Single-byte alphanumeric characters, hyphens ("-"), and underscores ("\_")<br>However, the string cannot start with a single-byte hyphen ("-") or underscore ("\_")|No||
...
MERGE -i -H 'If-Match: *' -H 'Authorization: Bearer AA~PBDc...(snip)...FrTjA' -H 'Accept: application/json' \
