---
id: version-1.7.18-2AE_Partial_Update_Relation
title: Relation partial update
sidebar_label: Relation partial update
original_id: 2AE_Partial_Update_Relation
---

## Overview

Partial update of Relation
...
|:--|:--|:--|:--|:--|
|Name|Relation Name|Number of digits: 1 - 128<br>Character type: Single-byte alphanumeric characters, hyphens ("-"), and underscores ("\_"), plus, :<br>However, the string cannot start with a underscore ("\_") or colon (:)|No||
...
```sh
curl "https://cell1.unit1.example/__ctl/Relation(Name='relation1',_Box.Name='box1')" -X MERGE -i \
